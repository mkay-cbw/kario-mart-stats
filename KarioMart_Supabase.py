...
css_config = float_css_helper(background="var(--default-backgroundColor)", transform="translateX(-50%)", width="90%", max_width="700px", top="4rem", left="calc(var(--sidebar-width, 0px) + (100vw - var(--sidebar-width, 0px)) / 2)", z_index="999")
